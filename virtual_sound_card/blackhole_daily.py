...
def find_blackhole_devices(audio_interface):
    """Find BlackHole input and output device indices."""
    ...
    return blackhole_input_index, blackhole_output_index
...
class DailyCall(daily.EventHandler):
    def __init__(self):
        ...
        blackhole_input_index, blackhole_output_index = find_blackhole_devices(self.__audio_interface)
        if blackhole_input_index is None or blackhole_output_index is None:
            print("BlackHole virtual audio devices not found. Please ensure they are installed.")
        ...
        self.__input_audio_stream = self.__audio_interface.open(
            ...
            rate=SAMPLE_RATE,
            input=True,
            input_device_index=blackhole_input_index,
        ...
        self.__output_audio_stream = self.__audio_interface.open(
            ...
            rate=SAMPLE_RATE,
            output=True,
            output_device_index=blackhole_output_index,
            frames_per_buffer=CHUNK_SIZE,
        )
